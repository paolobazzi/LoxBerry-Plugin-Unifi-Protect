...
LOGSTART "Loading Unifi Protect settings.";
...
LoxBerry::Web::lbheader("Unifi Protect Plugin V$version", "https://www.loxwiki.eu/display/LOXBERRY/BWT+Aqua", "help.html");
...
LOGEND "Unifi Protect settings finished.";
